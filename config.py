...
class Config:
    ...
    max_pattern_len: int = 100          # maxw in meta.npz
    ...
    # query lengths the scanner can produce: 1..50 plus 60/70/80/90/100
    query_len_choices: tuple = tuple(range(1, 51)) + (60, 70, 80, 90, 100)
